...
void goto_fromStart_toPosition1(){
  ...
  // son konumlar -> motor1=43, motor2=6, motor3=13, motor4=0, motor5=180
...
void goto_fromPosition1_toPosition2(){
  ...
  while(1){
    ...
    if(motor1.read()==88 && motor2.read()==35 && motor3.read()==28){
      break;
    }
...
void goto_fromPosition2_toPosition1(){
  ...
  while(1){
    ...
    if(motor1.read()==43 && motor2.read()==16 && motor3.read()==13){
      break;
    }
